  ...
  return (
    <div className="flex flex-col w-full mx-auto max-w-[88rem] items-center gap-5 md:gap-8 px-[30px] py-7 md:py-10 lg:py-12">
      <div className="w-full flex items-start justify-start self-start">
        <h2 className="text-[#595959] [font-family:Switzer] text-lg md:text-2xl font-medium leading-[160%]">
          key features
        </h2>
      </div>
      <div className="grid grid-cols-1 relative lg:grid-cols-3 w-full items-center justify-center">
        ...
        {keyFeatures.map((feature, index) => {
          ...
          const lastRowStartIndex =
            totalItems - (totalItems % itemsPerRow || itemsPerRow);
          ...
          return (
            ...
            >
              ...
              {typeof feature === "string" ? (
                <p className="text-[#595959] [font-family:Switzer] text-lg md:text-2xl font-medium leading-[160%]">
                  {feature}
                </p>
              ) : (
                <div className="text-center">
                  <h3 className="text-[#2A2A2A] text-xl font-semibold mb-2">
                    {feature.title}
                  </h3>
                  {feature.details.map((detail, i) => (
                    <p key={i} className="text-[#595959] text-lg mb-1">
                      {detail}
                    </p>
                  ))}
                </div>
